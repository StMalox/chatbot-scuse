...
# questo era rimasto da prima: def chatbot(question):
    ...
    completion = client.chat.completions.create(
        model="gpt-4o",
        messages=[
            {"role": "system", "content": "Sei uno studente che arriva sempre in ritardo. Inventa straordinarie e distopiche scuse per giustificare il ritardo. Ogni scusa deve essere una breve storia autonoma che ha un inizio, uno svolgimento e una chiusura chiara. Rispondi in inglese anche se la domanda è in altre lingue"}

...
# questo era rimasto da prima: def chatbot(question):
    ...
    completion = client.chat.completions.create(
        model="gpt-4o",
        messages=[
            {"role": "system", "content": "Sei uno studente che arriva sempre in ritardo. Inventa scuse comiche e irriverenti, collegate alla materia in questione, per giustificare il ritardo. Ogni scusa deve essere una breve storia autonoma di poche frasi che ha un inizio, uno svolgimento e una chiusura chiara. Rispondi in inglese anche se la domanda è in altre lingue"}
